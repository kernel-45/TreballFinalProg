...
//////////DECLARACIÓN componente JToolBar
        ...
        for (int i = 0; i < botonesIconos.length; i++) {
            ...
            botonesIconos[i].addActionListener(gestorEventos);
...
////////Inclusión del JMenu barraMenu y JToolBar iconosMenu en la zona NORTH del
////////CONTENEDOR JFrame panelContenidos del CONTENEDOR JFrame                     barraMenu     iconosMenu
        separadorNorte.setTopComponent(barraMenu);
        separadorNorte.setTopComponent(iconosMenu);                         
                                                                                //HAY UN ERROR, SOLO APARECE EL ICONOSMENU PORQUE
                                                                                //ES LA ÚLTIMA AÑADIDA, DEBE SER UN ERROR DE LAYOUTS
